...
def verify_face():
    try:
        ...
        result = DeepFace.verify(img1, img2, model_name="VGG-Face", distance_metric="cosine")  # detector_backend="retinaface"
        ...
        return jsonify({
            ...
            'threshold': custom_threshold,  # result.get('threshold', None)
            'model': "VGG-Face"
        })
